...
from CGAN_dfgan import CGAN_DFGAN
...
def parse_args():
    ...
    parser.add_argument('--gan_type', type=str, default='CGAN_DFGAN',
                        choices=['GAN', 'CGAN', 'infoGAN', 'ACGAN', 'EBGAN', 'BEGAN', 'WGAN', 'WGAN_GP', 'DRAGAN', 'LSGAN', 'CGAN_DFGAN'],
